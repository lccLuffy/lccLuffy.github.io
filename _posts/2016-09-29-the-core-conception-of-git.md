...
![本地版本控制](https://static.lufficc.com/image/cd558122189f264c90636f46c5b97bce.png)
...
![集中式版本控制](https://static.lufficc.com/image/150909dba84d774ff367e96633bb3a90.png)
...
![分布式版本控制](https://static.lufficc.com/image/8b98633e172b406026a6b18127160928.png)

## Git基础

Git是一个分布式版本控制系统，保存的是文件的完整快照，而不是差异变化或者文件补丁。

![保存每一次变化文件的完整内容](https://static.lufficc.com/image/a25948ea6ad62bc5f32c0f3473a26a82.png)
...
![未变化的文件只保存上一个版本的指针](https://static.lufficc.com/image/6ea58fd87fb479921752c3780c042f28.png)
...
现在再来看引用，就会很简单了。如果我们想要看某个提交记录之前的完整历史，就必须记住这个提交ID，但提交ID是一个40位的 SHA-1 校验和，难记。所以引用就是SHA-1 校验和的别名，存储在`.git/refs`文件夹中。
